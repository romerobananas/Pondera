...
const useWizard = ({ initialStepIndex = 0, onChange } = {}) => {
    ...
    const [maxActivatedStepIndex, setMaxActivatedStepIndex] = useState(initialStepIndex - 1);
    const stepTitles = [];
...
const Wizard = (props) => {
    ...
    return (React.createElement(WizardContext.Provider, { value: Object.assign({}, internalState) }, typeof props.children === "function"
...
export { useWizard, Wizard, WizardStep };
